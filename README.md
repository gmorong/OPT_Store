# 👟 OPT Store - Система управления складом
...
OPT Store - это веб-приложение для управления складскими операциями магазина спортивной обуви. Система поддерживает разные роли пользователей и предоставляет соответствующий функционал для каждой роли.
...
```bash
git clone https://github.com/твой-username/OPT_Store.git
cd OPT_Store
```
